...
void control(shared_ptr<Sai2Model::Sai2Model> robot,
			 Sai2Simulation::Sai2Simulation* sim);
...
void control(shared_ptr<Sai2Model::Sai2Model> robot,
	...
	auto motion_force_task = std::make_shared<Sai2Primitives::MotionForceTask>(
	...
	while (fSimulationRunning) {  // automatically set to false when simulation
		...
		command_torques = robot_controller->computeControlTorques();
	...
	std::cout << "Control Loop frequency : " << timer.elapsedCycles() / end_time
			  << "Hz\n";
}
...
void simulation(shared_ptr<Sai2Model::Sai2Model> robot,
	...
	std::cout << "Simulation Loop updates   : " << timer.elapsedCycles()
			  << "\n";
	std::cout << "Simulation Loop frequency : "
