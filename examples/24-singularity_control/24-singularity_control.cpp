...
int main (int argc, char** argv) {
	...
	// put robot near singular configuration
	// robot->_q << M_PI / 2 + 0.2, 0.2, M_PI / 2 + 0.2, 0.1, 0.1, 0.1;
	robot->_q << 90 - 10, 0, 90 + 10, -90, -30, 0;
	// robot->_q << 90, 0, 30, -90, -30, 0;
	robot->_q *= M_PI / 180;
	robot->updateModel();
...
void control(Sai2Model::Sai2Model* robot, Simulation::Sai2Simulation* sim) {
	...
	Vector3d pos_in_link = Vector3d(0,0.0,0.0); // location of the control frame in the link
