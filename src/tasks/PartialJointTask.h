...
#ifndef SAI2_PRIMITIVES_PARTIAL_JOINT_TASK_H_
#define SAI2_PRIMITIVES_PARTIAL_JOINT_TASK_H_
...
class PartialJointTask : public TemplateTask
{
...
public:
	 ...
	 *                        is to be controlled
     * @param      selection  Vector containing the controlled joint indices (i.e. [0, 1, 2, 3])
