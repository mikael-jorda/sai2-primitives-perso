...
// SNS
void PosOriTask::setJointLimits(std::pair<VectorXd, VectorXd> joint_pos_lim,
...
std::pair<VectorXd, int> PosOriTask::max(const VectorXd& x, const VectorXd& y, const VectorXd& z)
{
