...
void TwoHandTwoRobotsTask::updateTaskModel(const Eigen::MatrixXd N_prec_1, const Eigen::MatrixXd N_prec_2)
{
	...
	// MatrixXd W = _grasp_matrix.block(0,0,6,12);
	// MatrixXd K = _grasp_matrix.block(6,0,6,12);
	...
	// _robot_arm_1->J_0WorldFrame(J1_at_object_center, _link_name_1, _T_hand1_object.translation());
	...
	// _robot_arm_2->J_0WorldFrame(J2_at_object_center, _link_name_2, _T_hand2_object.translation());
	...
	// _Lambda_tot = _robot_1_effective_inertia + _robot_2_effective_inertia;
	...
	// MatrixXd J_tot = MatrixXd::Zero(12, dof_1+dof_2);
	...
	// MatrixXd A_tot = MatrixXd::Zero(dof_1+dof_2, dof_1+dof_2);
	// A_tot.block(0,0,dof_1,dof_1) = _robot_arm_1->_M;
	// A_tot.block(dof_1,dof_1,dof_2,dof_2) = _robot_arm_2->_M;

	// MatrixXd Lambda_r_inv = Jr * A_tot * Jr.transpose();
...
void TwoHandTwoRobotsTask::computeTorques(Eigen::VectorXd& task_joint_torques_1, Eigen::VectorXd& task_joint_torques_2)
{
	...
	// cout << "pi :\n" << M_PI << endl;
	// cout << "angle :\n" << R_12_aa.angle() << endl;
	// cout << "axis :\n" << R_12_aa.axis().transpose() << endl;
	// cout << "obj ori :\n" << _current_object_orientation << endl;
	// cout << endl;
